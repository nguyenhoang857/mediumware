...
Arduino.prototype.disconnectHelper = function() {
   for (var i = 0; i < 8; i++) {
      board.digitalWrite("D"+i, 0);
   }
}
...
Arduino.prototype.switchLight = function(pin, bool) {
...
Arduino.prototype.connect = function (port, verify) {
   ...
   board = new Particle({
     token: "62655973c4f93fcdf332a45d87a36c39db016bd2",
     deviceId: "340026000347343138333038"
   });



   board.on("ready", function() {
      board.digitalWrite("D5", 0);
...
Arduino.S4Afunctions =
    ...
    + '     board.on("ready", function(){board.digitalWrite("D5", 0)}\n'
    + '  }\n\n'
